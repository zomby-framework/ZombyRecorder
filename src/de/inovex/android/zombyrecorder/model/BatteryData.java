 ...
 *
 */
public class BatteryData implements ZombyElement {

	private int batteryLevel;
	private BatteryStatus batteryChargingStatus;
	
	public BatteryData(int batteryLevel, BatteryStatus batteryChargingStatus) {
	...
	public String getStringToFile() {
		return getSensorProperty() + ";" + batteryLevel + "," + batteryChargingStatus;
	}

	@Override
	public SensorProperty getSensorProperty() {
		return SensorProperty.BATTERY;
	}
