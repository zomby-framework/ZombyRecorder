...
public class ZombyRecorderActivity extends Activity  implements OnClickListener, Observer {
	...
	private void saveDialog() {
		...
		input.setText("MyRecord");
		
		new AlertDialog.Builder(this)
	    .setTitle("Saveing record...")
	...
	class ZombyFileAsync extends AsyncTask<String, Integer, String> {
	    ...
	    protected String doInBackground(String... aurl) {
		    ...
		    // write as zomby file
	 		try {
	 			outputStream = openFileOutput(filename + ZOMBY_POSTFIX, Context.MODE_PRIVATE);
	 		...
	 		try {
	 			...
	 			outputStream = openFileOutput(filename + ".java", Context.MODE_PRIVATE);
